...
public class AdvancedCircuit implements Recipe {
    ...
    @Inject AdvancedCircuit(@Named("assemblyMachine") ProductionCalc plantCalc, CopperCable copperCable, ElectronicCircuit electronicCircuit, PlasticBar plasticBar) {
